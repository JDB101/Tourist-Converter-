...
import { Typography, TextField, Select, MenuItem, Box, Container, Grid, Paper, SelectChangeEvent } from "@mui/material";
      ...
      <Box sx={{ my: 4 }}>
        ...
        <Paper elevation={3} sx={{ p: 3, mt: 3 }}>
          <Grid container spacing={2}>
            ...
            <Grid item xs={6}>
              <Select fullWidth value={fromUnit} onChange={(e) => setFromUnit(e.target.value)}>
            ...
            <Grid item xs={6}>
              <Select fullWidth value={toUnit} onChange={(e) => setToUnit(e.target.value)}>
                {currentCategory?.units.map((unit) => (
                  <MenuItem key={unit} value={unit}>
                    {unit}
                  </MenuItem>
